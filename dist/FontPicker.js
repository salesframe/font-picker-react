...
var FontPicker = (function (_super) {
    ...
    function FontPicker(props) {
        ...
        _this.generateFontList = function (fonts) {
            ...
            return (React__default.createElement("ul", { className: "font-list" }, filteredFonts.map(function (font) {
                ...
                return (React__default.createElement("li", { key: fontId, className: "font-list-item " + listClassName },
                    React__default.createElement("button", { type: "button", id: "font-button-" + fontId + _this.fontManager.selectorSuffix, className: "font-button " + (isActive ? "active-font " + activeClassName : ""), onClick: _this.onSelection, onKeyPress: _this.onSelection }, font.family)));
            })));
        };
        ...
        _this.render = function () {
            var _a = _this.props, activeFontFamily = _a.activeFontFamily, sort = _a.sort, isSearchable = _a.isSearchable, inputClassName = _a.inputClassName, rootClassName = _a.rootClassName, buttonClassName = _a.buttonClassName;
            ...
            return (React__default.createElement("div", { id: "font-picker" + _this.fontManager.selectorSuffix, className: (expanded ? "expanded" : "") + " " + rootClassName },
                !expanded ? (React__default.createElement("button", { type: "button", className: "dropdown-button " + buttonClassName, onClick: _this.toggleExpanded, onKeyPress: _this.toggleExpanded },
    ...
    FontPicker.defaultProps = {
        ...
        activeClassName: fontManager.OPTIONS_DEFAULTS.activeClassName,
        buttonClassName: fontManager.OPTIONS_DEFAULTS.buttonClassName
    };
    return FontPicker;
}(React.PureComponent));
